...
import ankit from "../assets/Images/ankit-rajbhandari (2).jpg";
    ...
    <>
      <div className="">
        <div className="flex md:flex-row flex-col-reverse justify-center">
          <div className="flex-1 py-12 px-2 md:py-36 md:px-36">
            ...
            <p className="  text-xl mb-5">Male | 24 | Full Time Travel Guide</p>
            <p className="  text-xl">
              A full time guide and a part time traveler. Been guiding tourists
              from all over the globe since 3+ years. Bardiya being my hometown,
              I know all the nooks and corners of it so you can be assured to
              have a good time. I love Bardiya and so should you. Let me show
              you why.
            </p>
          ...
          <div className=" flex flex-1 relative justify-end mr-5 ml-5">
            <img src={ankit} className="h-4/6  rounded-b-3xl" alt="ankit" />
      ...
      <div className="tipping_section py-24 px-2 flex flex-col  md:flex-row md:px-40">
        <div className="section_left">
          ...
          <p className="text-xl md:text-xl mb-5">
            English Speaking, Friendly, Funny, Knows Unknown Local Paradises
          </p>
        </div>
      </div>
      {/* Itinery */}
      ...
      <div className="include_exclude flex justify-center md:justify-between md:w-5/6 mx-auto py-10 bg-gray-100 rounded-3xl md:shadow-2xl mb-10 md:mb-40 md:py-32 md:px-20">
        <div className="include flex flex-col ml-2">
          ...
          <p className="text-xl">10:00AM to 6:00PM service</p>
          <p className="text-xl">At least 2 tractions</p>
          <p className="text-xl">Local Food Place for Lunch</p>
          <p className="text-xl">Inital Cost only covers 1 Guest</p>
          <p className="text-xl">$10 each for additional guest upto 4 person</p>
          <p className="text-xl">A Good Time </p>
        </div>
